...
";
  ...
  $mail->SetFrom('noreply@grafoexpress.com', '1erDirectorio Escolar');

 $email_empresa="contacto@grafoexpress.com"
  $address = $email;
 ...
 // $mail->AddCC('clientes@1erd.com ', 'Copia de mensaje');
  ...
  $mail->AddAddress('1erdirectorio@gmail.com', 'Copia de mensaje Contacto Escolar');
