...
if (!$_POST['message']) {
  $errMessage = 'No se registro mensaje alguno o comentario. ';
}
...
<div class="divider" id="section5"></div>
  ...
  <div class="col-sm-9 col-sm-offset-1">
      <form role="form" action="indexperimento.php" method="post">
      <div class="row form-group">
        ...
        <div class="col-xs-4">
          <input type="text" class="form-control" value="<?php echo htmlspecialchars($_POST['name']); ?> " id="nombre" name="nombre" placeholder="Nombre">
        </div>
        <div class="col-xs-6">
           <input type="text" class="form-control" value="<?php echo htmlspecialchars($_POST['name_company']); ?>" id="nombre_compa" name="nombre_compa" placeholder="Compañia">
        </div>
      </div>
      <div class="row form-group">
          <div class="col-xs-5">
          <input type="email" class="form-control "  value="<?php echo htmlspecialchars($_POST['correo']); ?>" name="correo" id="correo" placeholder="Correo">
          </div>
          <div class="col-xs-5">
          <input type="text" class="form-control"  value="<?php echo htmlspecialchars($_POST['telefono']); ?>" id="telefono" name="telefono" placeholder="Teléfono">
          </div>
      </div>
      <div class="row form-group">
          <div class="col-xs-10">
